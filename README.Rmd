...
Setting `as_yaml_tags = TRUE` in `spot_pkgs()` flattens the dependencies and outputs them in a format that can be copied and pasted into the **tags** section of a blogdown post's YAML header. See ([blogdown#647](https://github.com/rstudio/blogdown/issues/647)).
